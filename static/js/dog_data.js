var dog_data = [
    ...
    },
    {
      ...
      "description": "The Catahoula Leopard Dog is a medium-large, short-coated dog, known for its many varied coat and eye colors and patterns. The word catahoula is of Choctaw origin and is translated to mean “sacred lake.” Catahoulas are the only breed of dog to have historically originated in the state of Louisiana. The breed requires firm guidance and early socialization, as they can be independent, territorial, and protective. For the same reasons, they do not allow mistreatment and will assert themselves in self-defense. Once they know their place in the family unit, they are affectionate, loyal, and gentle. Also called the Catahoula Hog Dog, they are used as stock dogs, bay dogs, tree dogs, watchdogs, guard dogs, and of course as loyal companions. The Catahoula Leopard Dog is a multi-purpose working dog that is well-muscled and powerful, but with a sense of agility and endurance. They are serious while working and playful at home.",
    ...
    },
    {
      ...
      "description": "This breed entered the American Kennel Club Foundation Stock Services Program (AKC FSS) in 2011. They are eligible to compete in Agility, Barn Hunt, Flyball, Herding, Lure Coursing, Nosework, Obedience and Rally, Tracking and AKC FSS Open Shows. Club Contact DetailsClub: Danish/Swedish Farmdog Club of America, IncName: Dorothy Herman, AKC LiaisonEmail: Info@Farmdogs.org Known as the Little Big Dog, the Danish-Swedish Farmdog is a companion dog that loves to work and enjoys a challenge. They are a small, compact and slightly rectangular dog, known to mature late.",
    ...
    {
      "Breed": "Kishu Ken",
      "description": "The Kishu Ken is a great dog for an active person and has the ability to be an easy-going house dog when they are not out and about. They are medium-sized, well balanced, and their muscles are well developed. They have pricked ears and a curled or sickle tail. Kishus are very loving and affectionate with their families and need to be included in activities. They are great with kids if raised with them, but they are often aloof with strangers. Kishu Ken have high prey drives and might like to give chase to small animals. If he is raised with a small animal such as a cat, he could do well with them, but most Kishus can’t help but give in to their instincts. Club Contact DetailsClub: American Kishu Ken ClubName: Carleen NewmanEmail: kishuken1@gmail.com Club: National Kishu ClubName: C.J. Hammond – PresidentEmail: info@kishuclub.com The Kishu Ken is a dog of noteworthy endurance, showing nobility, dignity, and naive feeling. His temperament is faithful, docile, and very alert.",
    ...
    {
      "Breed": "Pudelpointer",
      "description": "The Pudelpointer originated in Germany, created by crossing the Poodle with the Pointer. A versatile, genetically sound and healthy gun dog emerged from this cross and the breed is useful for all kinds of work in the fields, woods and water. His coat can be wire-haired, smooth/short, or rough and his coat color ranges from light brown to black. He may also have small white markings. The Pudelpointer is a calm, self-controlled, versatile gun dog with a distinct hunting instinct and lacks game or gun shyness. In his native country of Germany, he has always ranked high in performance tests and in the field. This breed is enjoyed and valued for its desire and drive.",
      "temperament": "Friendly, Smart, Willing to Please",
      "average_height": 61,
      "average_weight": 26.1,
      "average_expectancy": 14,
    ...
    },
    {
      ...
      "description": "These tough, lean, and lively herders, famous for their vigorous and free-flowing movement, come in two coat varieties: rough-faced and smooth-faced. Roughs have profuse, “windswept” hair above the muzzle and a generally harsh coat; smooths have short facial hair, a finer-textured coat, and a slightly longer, pointier muzzle. Both varieties of this sinewy, rectangular breed come in many colors and patterns. Pyr Sheps see the world through dark almond-shaped eyes conveying an alert and cunning expression. Enthusiastic, mischievous, and whip-smart, the Pyrenean Shepherd is an indefatigable herder descended from ancient sheepdogs of the Pyrenees mountains. Tough and sinewy Pyr Sheps come in “rough-faced” and “smooth-faced” coat varieties.",
    ...
    },
    {
      ...
      "description": "Since the beginning of the breed’s history, Rafeiros Alentejanos were used in packs as hunting dogs for big game, though this function has gradually disappeared over time. More recently, the breed is a guard dog for property and livestock, watching sheep and cattle. They also often work alone in prairies and will defend the herd against any intruders. Hailing from Portugal, the Rafeiro do Alentejo is a large-sized dog, powerful, rustic, sober, and calm. He moves with a heavy, slow roll. His coat is short or medium-length and thick, straight and dense. They can be black, wolf grey, or fawn, with or without brindling, always with white markings; or white with patches of these colors. The Rafeiro do Alentejo is an excellent farm and estate watch dog. He is also a very useful livestock protector, being more vigilant at night and very serious when guarding territory or any other property entrusted to him. He has a calm and confident expression.",
    ...
    },
    {
      ...
      "description": "Used for centuries to guard livestock in its homeland of Romania, the Mioritic Sheepdog is a typical Livestock Guarding Dog (LGD). Loyal, reliable, independent, and fiercely protective, he is friendly and devoted to his family but very mistrusting of strangers. It is a large dog with long coat which requires regular grooming, and with any dog of this size and temperament requires daily exercise and basic obedience training.Mioritics are lively and stubborn but in spite of all their independence they are very sensitive creatures in their furry armor. As puppies they stick to the pack which has accepted them. This can be any kind of creature – dog, cat, horse, sheep, the Mioritic needs very close family ties; a house without doors it thinks would be ideal. This certainly depends a great deal on the weather. Its favorite place is always very close to its favorite person. It determines its resting place itself. This may even be the couch or a carpet not suitable for dogs, but as a rule shepherds, even as puppies, prefer to sleep on hard ground. They need no dog baskets, no special mattresses and by no means an allocated place. No “work creating” program is necessary but daily walks and hikes provide exciting variation. The Romanian Mioritic Shepherd Dog origins come from near the Carpathian Mountains. The breed is very impressive in size and character.",
    ...
    },
    {
      ...
      "energy_level_category": "Energetic",
      "trainability_category": "May be Stubborn",
      "demeanor_category": "Reserved with Strang"
    }
  ]